...
<?php $__env->startSection('content'); ?>
	...
	<?php foreach($userProgramAccess as $access): ?>
		<?php if($access->program_code == Config::get('constants.MODULE_CODE_INVOICE')): ?>
			...
			<div class="col-md-offset-2 col-md-8">
				...
				<div class="portlet box blue">
					...
					<div class="portlet-body">
						...
						<form method="POST" action="<?php echo e(url('/readfile')); ?>" class="form-horizontal" enctype="multipart/form-data" id="formReadfile">
							<input type="hidden" name="_token" id="csrf-token" value="<?php echo e(Session::token()); ?>" />
							<div class="form-body">
								<div class="form-group">
									<label class="control-label col-md-3">Imported Data</label>
									<div class="col-md-5">
										<input type="file" class="filestyle" data-buttonName="btn-primary" name="importedData" id="importedData" <?php echo e($readonly); ?>>
									</div>
									<div class="col-md-2">
										<button type="submit" class="btn green pull-right btn-md" <?php echo e($state); ?>>
								...
								<div class="form-group">
									...
									<div class="col-md-2">
										<a href="javascript:;" id="calculate" class="btn yellow pull-right btn-md calculate" <?php echo e($state); ?>>
			...
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<div class="col-md-5">
						...
						<a href="<?php echo e(url('/varianceexcel')); ?>" id="btn_excel_variance" class="btn blue pull-right btn-sm">Over Delivery</a>
					</div>
				</div>
			</div>
		</div>
...
<script type="text/javascript">
	$( document ).ready(function(e) {
		$('#btn_csv_nonvariance').on('click', function(){
			window.location.href = "<?php echo e(url('/nonvariancecsv')); ?>";
		});
		...
		$('.calculate').on('click', function(e){
			...
			if ($('#invoice').val() != '') 
			{
				...
				$.ajax({
					url: "<?php echo e(url('/nonvariancecsv')); ?>",
					type: 'GET',
					dataType: 'JSON',
					data: data
				}).done( function(data, textStatus, jqXHR) 
				{
					...
					$('#loading').modal('hide');
					window.location.href = "<?php echo e(url('/nonvarianceexcel')); ?>";
		...
		$('#btn_pdf_overdelivery').on('click', function() {
			window.location.href = "<?php echo e(url('/overdeliverypdf')); ?>";
		});

		$('#btn_excel_unitcost').on('click', function() {
			window.location.href = "<?php echo e(url('/unitcostexcel')); ?>";
		});
	});
</script>
<?php $__env->stopPush(); ?>
