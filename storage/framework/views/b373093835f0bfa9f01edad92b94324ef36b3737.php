	...
	<div class="modal-dialog gray-gallery">
		<div class="modal-content ">
			...
			<form class="form-horizontal">
				...
				<div class="modal-footer">
					<?php /* <a href="javascript:kittingList();" class="btn btn-success" target="_blank">Search</a> */ ?>
					<button type="button" id="search_kitting" name="search_kitting" class="btn btn-success">Search</button>
					<button type="button" data-dismiss="modal" class="btn btn-danger">Close</button>
				</div>
			</form>
		</div>
