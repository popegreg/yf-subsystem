                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control input-sm  show-tick" name="packing_type" id="packing_type">
                                            <option value=""></option>
                                            <?php /* <?php foreach($packingtypes as $packingtype): ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control input-sm  show-tick" name="unit_condition" id="unit_condition">
                                            <option value=""></option>
                                            <?php /* <?php foreach($unitconditions as $unitcondition): ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control input-sm  show-tick" name="packing_operator" id="packing_operator">
                                            <option value=""></option>
                                            <?php /* <?php foreach($packingoperators as $packingoperator): ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control input-sm  show-tick" name="pack_code_per_series" id="pack_code_per_series">
                                            <option value=""></option>
                                            <?php /* <?php foreach($packingcodeperseries as $packingcodeperserie): ?>
...
$(function() {
    initData();
    loadPackdata("<?php echo e(url('/packgetrows')); ?>"+"?mode=");
    lot_accepted();
    totalmod();
    ...
    $('#tblforpacking').on('click','.edit-task', function(e) {
        ...
        if (edittext[4] !== "<?php echo e(Auth::user()->user_id); ?>" || edittext[4] !== "<?php echo e(Auth::user()->firstname); ?>") {
    ...
    $('#btn_pdf').on('click', function() {
        ...
        var url = "<?php echo e(url('/packingprintreport?data=')); ?>" + encodeURIComponent(JSON.stringify(tableData));
    ...
    $('#btn_excel').on('click', function(){
        ...
        var url = "<?php echo e(url('/packingprintreportexcel?data=')); ?>" + encodeURIComponent(JSON.stringify(tableData));
        window.location.href= url;
    });
...
function groupby(){
    ...
    var urls = "<?php echo e(url('/packgetrows')); ?>"+"?_token="+"<?php echo e(Session::token()); ?>"+"&&mode=group&&datefrom="+datefrom+
...
function searchby(){
    ...
    var urls = "<?php echo e(url('/packgetrows')); ?>"+"?_token="+"<?php echo e(Session::token()); ?>"+"&mode=search&&datefrom="+datefrom+
...
function initData() {
    $.ajax({
        url: "<?php echo e(url('/packinginspection-initdata')); ?>",
        type: 'GET',
        dataType: 'JSON',
