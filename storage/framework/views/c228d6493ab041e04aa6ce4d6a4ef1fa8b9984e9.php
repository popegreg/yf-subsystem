																...
																<tbody>
																	<?php foreach($masters as $ms): ?>
																		<tr>
																			...
																			<td>
																				<input type="checkbox" class="checkboxes rw" name="rw[]" value="<?php echo e($ms->program_code); ?>" <?php echo($state); ?> />
																			</td>
																			<td>
																				<input type="checkbox" class="checkboxes r" name="r[]" value="<?php echo e($ms->program_code); ?>" <?php echo($state); ?> />
																			</td>
																		</tr>
																	<?php endforeach; ?>
																</tbody>
																	...
																	<?php foreach($operations as $op): ?>
																		<tr>
																			...
																			<td>
																				...
																				?>
																				<input type="checkbox" class="checkboxes rw <?php echo $idrw;?>" name="rw[]" value="<?php echo e($op->program_code); ?>" <?php echo($state); ?> />
																			</td>
																			<td>
																				<input type="checkbox" class="checkboxes r <?php echo $idr;?>" name="r[]" value="<?php echo e($op->program_code); ?>" <?php echo($state); ?> />
																			</td>
																		</tr>
																	<?php endforeach; ?>
																</tbody>
																...
																<tbody>
																	<?php foreach($sssprog as $sssprg): ?>
																		<tr>
																			...
																			<td>
																				<input type="checkbox" class="checkboxes rw SSSrw" name="rw[]" value="<?php echo e($sssprg->program_code); ?>" <?php echo($state); ?> />
																			</td>
																			<td>
																				<input type="checkbox" class="checkboxes r SSSr" name="r[]" value="<?php echo e($sssprg->program_code); ?>" <?php echo($state); ?> />
																			</td>
																		</tr>
																	<?php endforeach; ?>
																</tbody>
																...
																<tbody>
																	<?php foreach($wbsprog as $wbsprg): ?>
																		<tr>
																			...
																			<td>
																				<input type="checkbox" class="checkboxes rw WBSrw" name="rw[]" value="<?php echo e($wbsprg->program_code); ?>" <?php echo($state); ?> />
																			</td>
																			<td>
																				<input type="checkbox" class="checkboxes r WBSr" name="r[]" value="<?php echo e($wbsprg->program_code); ?>" <?php echo($state); ?> />
																			</td>
																		</tr>
																	<?php endforeach; ?>
																</tbody>
																...
																<tbody>
																	<?php foreach($qcdbprog as $qcdbprg): ?>
																		<tr>
																			...
																			<td>
																				<input type="checkbox" class="checkboxes rw QCDBrw" name="rw[]" value="<?php echo e($qcdbprg->program_code); ?>" <?php echo($state); ?> />
																			</td>
																			<td>
																				<input type="checkbox" class="checkboxes r QCDBr" name="r[]" value="<?php echo e($qcdbprg->program_code); ?>" <?php echo($state); ?> />
																			</td>
																		</tr>
																	<?php endforeach; ?>
																</tbody>
																...
																<tbody>
																	<?php foreach($qcmldprog as $qcmldprg): ?>
																		<tr>
																			...
																			<td>
																				<input type="checkbox" class="checkboxes rw QCMLDrw" name="rw[]" value="<?php echo e($qcmldprg->program_code); ?>" <?php echo($state); ?> />
																			</td>
																			<td>
																				<input type="checkbox" class="checkboxes r QCMLDr" name="r[]" value="<?php echo e($qcmldprg->program_code); ?>" <?php echo($state); ?> />
																			</td>
																		</tr>
																	<?php endforeach; ?>
																</tbody>
																...
																<tbody>
																	<?php foreach($security as $sec): ?>
																		<tr>
																			...
																			<td>
																				<input type="checkbox" class="checkboxes rw secrw" name="rw[]" value="<?php echo e($sec->program_code); ?>" <?php echo($state); ?> />
																			</td>
																			<td>
																				<input type="checkbox" class="checkboxes r secr" name="r[]" value="<?php echo e($sec->program_code); ?>" <?php echo($state); ?> />
																			</td>
																		</tr>
																	<?php endforeach; ?>
																</tbody>
