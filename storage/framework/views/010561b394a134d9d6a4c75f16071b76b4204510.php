		...
		<div class="modal-dialog">
			...
			<div class="modal-content blue">
							...
							<div class="form-group">
                                ...
                                <div class="col-md-7">
                                    <div class="input-group input-large date-picker input-daterange" data-date="<?php echo date("Y-m-d"); ?>" data-date-format="yyyy-mm-dd">
                                        <input type="text" class="form-control input-sm reset" name="mkl_from" id="mkl_from" autocomplete="false"/>
                                        <span class="input-group-addon">to </span>
                                        <input type="text" class="form-control input-sm reset" name="mkl_to" id="mkl_to" autocomplete="false"/>
                                    </div>
                                </div>
                            </div>
							<div class="form-group">
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-sm blue-madison mkl_reports" data-mode="summary"><i class="fa fa-file-excel-o"></i> Material Kitting Summary</button>
					<button type="button" class="btn btn-sm green mkl_reports" data-mode="dispatch"><i class="fa fa-file-excel-o"></i> Generate Dispatch</button>
	...
	<div id="sakidashiModal" class="modal fade" role="dialog">
		<div class="modal-dialog">
			...
			<div class="modal-content blue">
					...
					<div class="col-md-12">
						<form class="form-horizontal">
							<div class="form-group">
                                ...
                                <div class="col-md-7">
                                    <div class="input-group input-large date-picker input-daterange" data-date="<?php echo date("Y-m-d"); ?>" data-date-format="yyyy-mm-dd">
                                        <input type="text" class="form-control input-sm reset" name="saki_from" id="saki_from" autocomplete="false"/>
                                        <span class="input-group-addon">to </span>
                                        <input type="text" class="form-control input-sm reset" name="saki_to" id="saki_to" autocomplete="false"/>
                                    </div>
                                </div>
                            </div>
							<div class="form-group">
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-sm blue-madison saki_reports" data-mode="summary"><i class="fa fa-file-excel-o"></i> Sakidashi Issuance Summary</button>
					<button type="button" class="btn btn-sm green saki_reports" data-mode="dispatch"><i class="fa fa-file-excel-o"></i> Generate Dispatch</button>
					<button type="button" style="font-size:12px" class="btn btn-sm btn-danger" data-dismiss="modal"><i class="fa fa-times"></i> Close</button>
				</div>
			</div>
		</div>
	...
	<div id="physicalModal" class="modal fade" role="dialog" data-backdrop="static">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button type="button" id="phy_exportToExcel" class="btn btn-sm green"><i class="fa fa-file-excel-o"></i> Generate Excel</button>
					<button type="button" style="font-size:12px" class="btn btn-sm btn-danger" data-dismiss="modal"><i class="fa fa-times"></i> Close</button>
				</div>
			</div>
		</div>
		...
		<div class="modal-dialog">
			...
			<div class="modal-content blue">
					...
					<div class="col-md-12">
						<form class="form-horizontal">
							<div class="form-group">
                                ...
                                <div class="col-md-7">
                                    <div class="input-group input-large date-picker input-daterange" data-date="<?php echo date("Y-m-d"); ?>" data-date-format="yyyy-mm-dd">
                                        <input type="text" class="form-control input-sm reset" name="wmi_from" id="wmi_from" autocomplete="off"/>
                                        <span class="input-group-addon">to </span>
                                        <input type="text" class="form-control input-sm reset" name="wmi_to" id="wmi_to" autocomplete="off"/>
                                    </div>
                                </div>
                            </div>
							<div class="form-group">
				...
				<div class="modal-footer">
					...
					<button type="button" id="" class="btn btn-sm green pmr_wmi_report" data-mode="pmr"><i class="fa fa-file-excel-o"></i> Production Request</button>

					<button type="button" id="" class="btn btn-sm blue pmr_wmi_report" data-mode="wmi"><i class="fa fa-file-excel-o"></i> Warehouse Issuance</button>
