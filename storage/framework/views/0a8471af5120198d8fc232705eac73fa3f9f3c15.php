...
$(function() {
    loadFGSdata("<?php echo e(url('/FGSgetrows')); ?>?mode=");
    ...
    $('#btn_pdf').on('click', function() {
        ...
        var url = "<?php echo e(url('/fgsprintreport?data=')); ?>" + encodeURIComponent(JSON.stringify(tableData));
    ...
    $('#btn_excel').on('click', function() {
        ...
        var url = "<?php echo e(url('/fgsprintreportexcel?data=')); ?>" + encodeURIComponent(JSON.stringify(tableData));
        window.location.href= url;
    });
...
function groupby(){
    ...
    var urls = "<?php echo e(url('/FGSgetrows')); ?>"+"?_token="+"<?php echo e(Session::token()); ?>"+"&&mode=group"+"&&g1="+g1+"&&g2="+g2+"&&g3="+g3+"&&datefrom="+datefrom+"&&dateto="+dateto;
...
function searchby(){
    ...
    var urls = "<?php echo e(url('/FGSgetrows')); ?>"+"?_token="+"<?php echo e(Session::token()); ?>"+"&&mode=search"+"&&datefrom="+datefrom+"&&dateto="+dateto+"&&pono"+pono;
