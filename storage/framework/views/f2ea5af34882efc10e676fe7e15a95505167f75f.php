...
<div id="success" class="modal fade" role="dialog" data-backdrop="static">
	<div class="modal-dialog modal-sm gray-gallery">
		<div class="modal-content ">
			<form class="form-horizontal" role="form" method="POST" action="<?php echo e(url('/ypicsr3/print-orderdatareport')); ?>" id="frm_print">
				<?php echo csrf_field(); ?>

				<div class="modal-body">
					<p>You successfully generated all the needed data.</p>
				</div>
				<input type="hidden" id="selected_dbconnect" name="selected_dbconnect" value="<?php if(Session::has('dbconnection')): ?> <?php echo e(Session::get('dbconnection')); ?><?php endif; ?>">
				<input type="hidden" id="selected_supplier"  name="selected_supplier" value="<?php if(Session::has('selected_supplier')): ?> <?php echo e(Session::get('selected_supplier')); ?><?php endif; ?>">
				<div class="modal-footer">
