                    ...
                    <div class="col-md-12">
                        <form class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control input-sm clearbatch" id="edt_lot_no" <?php echo($readonly); ?> readonly/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputname" class="col-md-3 control-label">Location</label>
                                <div class="col-md-9">
                                    <input type="text" class="form-control input-sm clearbatch" id="edt_loc" <?php echo($readonly); ?> readonly/>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="inputname" class="col-md-3 control-label">Exp. Date</label>
                                <div class="col-md-9">
                                    <input class="form-control clear clearinv input-sm date-picker" size="16" type="text" id="edt_exp_date" <?php echo($readonly); ?>/>
                                </div>
                            </div>
                            <div class="form-group">
