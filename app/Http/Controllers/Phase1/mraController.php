            ...
            $db = DB::connection($this->mssql)
                    ->select("SELECT i.CODE,    
                        ...
                        LEFT join (SELECT z.CODE,
                                      ...
                                      FROM XZAIK z
                                        LEFT JOIN XZAIK z1 ON z1.CODE = z.CODE AND z1.HOKAN = 'WHS100' AND z1.JYOGAI <> '1'
                                        LEFT JOIN XZAIK z2 ON z2.CODE = z.CODE AND z2.HOKAN = 'WHS102' AND z2.JYOGAI <> '1'
                                        LEFT JOIN XZAIK z3 ON z3.CODE = z.CODE AND z3.HOKAN = 'WHS-NON' AND z3.JYOGAI <> '1'
                                        LEFT JOIN XZAIK za1 ON za1.CODE = z.CODE AND za1.HOKAN = 'ASSY100' AND za1.JYOGAI <> '1'
                                        LEFT JOIN XZAIK za2 ON za2.CODE = z.CODE AND za2.HOKAN = 'ASSY102'  AND za2.JYOGAI <> '1'
                                        LEFT JOIN XZAIK z4 ON z4.CODE = z.CODE AND z4.HOKAN = 'WHS-SM' AND z4.JYOGAI <> '1'
                                    WHERE z.JYOGAI <> '1' 
