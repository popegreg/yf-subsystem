...
class DropdownController extends Controller
{
    ...
    public function postAddDropdown(Request $request_data)
    {
        try
        {
            ...
            $msg ='';
            $result = 0;
            // dd($table,$master,$description,$category,$action);

            $msg_type ='message';


            $dataexist = DB::connection($this->common)->table('tbl_mdropdowns')->where('description', $description)->where('category', $category)->get();
